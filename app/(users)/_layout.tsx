...
const UsersLayout = () => {
  ...
  const isScreen1 = pathname === "/screen1";
  const isScreen2 = pathname === "/screen2";
  return (
    <SafeAreaView style={styles.container} edges={["top", "bottom"]}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.footerItem} onPress={() => {
          ...
          <MaterialIcons name="home" size={24} color={!isScreen2 ? "#1e88e5" : "#999"} />
        ...
        <TouchableOpacity style={styles.footerItem} onPress={() => {
          router.push('/(reports)/screen1')
        }}>
          <MaterialIcons name="description" size={24} color={!isScreen2 && !isScreen1 ? "#1e88e5" : "#999"} />
